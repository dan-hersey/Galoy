...
async function runTests() {
  ...
  const store = new LoanStore(null);
  ...
  const convStore = new LoanStore(null);
  ...
  const handlerStore = new LoanStore(null);
  ...
  const alertStore = new LoanStore(null);
  ...
  const ltvAlertStore = new LoanStore(null);
  ...
  const serverStore = new LoanStore(null);
  const testPort = 3999;
  ...
  const lpStore = new LoanStore(null);
  ...
  const minLoan = new LoanStore(null);
  ...
  const delStore = new LoanStore(null);
  ...
  const fmtStore = new LoanStore(null);
